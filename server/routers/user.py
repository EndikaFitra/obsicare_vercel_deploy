...
from app.schemas.user_schema import UserUpdate, UserResponse, UserResponseUsernameEmail, UpdateBBTB
...
faktor_aktivitas = [1.2, 1.375, 1.55, 1.725]
...
def update_user_profile(
    ...
    user.usia = user_update.usia
    user.berat_badan = user_update.berat_badan
    user.tinggi_badan = user_update.tinggi_badan
    user.jenis_kelamin = user_update.jenis_kelamin
    user.aktivitas_fisik = user_update.aktivitas_fisik
...
@router.get("/username&email", response_model=UserResponseUsernameEmail)
